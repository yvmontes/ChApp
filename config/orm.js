...
let orm = {
    ...
    SelectAll: function(table, callback){
        connection.query("select * from " + table + " order by chatTime DESC limit 100", function(){
            if (err) throw err;
            callback(result);
        })
    },

    AddChat: function(table){
        connection.query("INSERT INTO " + table + "(username, chat, chatTime) VALUES (" )
    }
